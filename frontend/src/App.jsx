...
const educationCards = [
  {
    // Continuing education in advanced javaScript programming with TypeScript and EcmaScript at Future Education (Remote)
    startDate: '11/2024',
    endDate: '12/2024',
    logotype: Future_education_Logo_white,
    ...
    <body>
      ...
      <div className="min-h-svh flex flex-col justify-center items-center">
        ...
        <div className="flex flex-row justify-start items-end">
          ...
          {/* <img src={swLogo} className="-ml-20 w-10 h-auto md:w-24 md:h-auto " alt="Sebastian Weber logo" /> */}
           
           <div className='w-12 h-auto md:w-24'>
           <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 42 25">
              <path d="M0.00302124 10.069V12.369L20.614 20.814V18.836L15.093 16.621V16.61L13.32 15.854L1.952 11.366L13.322 6.90999V6.92L15.095 6.23201L20.616 4.01701V1.89201L0.00302124 10.069Z" fill="#CBD5E1"/>
              <path d="M20.611 16.359V14.059L0 5.61V7.588L5.521 9.80299V9.81801L7.29401 10.574L18.662 15.062L7.29401 19.521V19.511L5.521 20.199L0 22.414V24.539L20.611 16.359Z" fill="#CBD5E1"/>
              <path d="M25.829 20.61H28.129L36.574 -0.000991821H34.596L32.381 5.52101H32.366L31.61 7.29301L27.122 18.661L22.663 7.29301H22.673L21.985 5.52101L19.77 -0.000991821H17.645L25.829 20.61Z" fill="#CBD5E1"/>
              <path d="M31.031 20.685H33.331L41.776 0.0730133H39.798L37.583 5.59499H37.568L36.812 7.36699L32.324 18.735L27.865 7.36699H27.875L27.187 5.59499L24.972 0.0730133H22.847L31.031 20.685Z" fill="#CBD5E1"/>
            </svg>
           </div>
                ...
                <div className="pt-2 flex flex-row justify-center ">
                  ...
                  <div className='px-2'>
                    ...
                    >
                      ...
                      <span className="sr-only">E‑Mail an Sebastian Weber senden</span>
                    </a>
                  </div>
         ...
         <div className="p-4">
            ...
            {aboutSection.map((card, index) => (
              <div key={index} className="flex flex-col justify-center text-start items-center py-10 px-4 font-light text-balance text-slate-400 leading-tight sm:text-lg md:text-base">
                {card.introduction}
              </div>
            ))}
          ...
          <div className="p-4 pt-6">
            ...
            {projectsSection.map((card, index) => (
              <div key={index} className="flex flex-col justify-center text-start items-center py-6 px-4 font-light text-balance text-slate-400 leading-tight sm:text-lg md:text-base">
                {card.introduction}
              </div>
                ))}
          </div>
                ...
                <div className="flex flex-col items-start ">
                  <div className="flex flex-wrap justify-start lg:flex-grow flex-1 ">
                    <div className="flex flex-col px-4 items-start ">
                      {/* <a className="flex flex-row invisible pr-2 text-lg sm:text-xl md:text-2xl xl:text-2xl" href={card.linkNetlify}>
                      ...
                      <h4 className="font-semibold text-2xl text-start text-balance text-slate-300">{card.subheading}</h4>
                      <br></br>
                    </div>  
                    <div className="flex flex-col p-4 justify-center items-center sm:justify-start sm:items-start md:justify-start md:items-start lg:justify-start lg:items-start xl:justify-start xl:items-start">
                          ...
                          <a alt={card.image4Description} href={card.image4} target="_blank">
                            <img className="h-36 md:h-42 lg:h-48 xl:h-56 px-2 p-1" src={card.image4} alt="123Test" />
                          </a>
                    ...
                    <div className="flex flex-col  min-w-42 mx-4 justify-start items-start sm:justify-start sm:items-start md:justify-start md:items-start lg:justify-start lg:items-start xl:justify-start xl:items-start">
                      ...
                      <div className="flex flex-wrap justify-center items-center">
                        <div className="flex flex-col mx-2 justify-center items-center">
                          <a alt={card.image4Description} href={card.image1} target="_blank">
                            <img className="h-36 md:h-42 lg:h-48 xl:h-56 px-2 p-1" src={card.image1} alt={card.image1Description} />
                          </a>  
                        ...
                        <div className="flex flex-col min-w-42 mx-4 justify-center items-center">
                          <a href={card.image2} target="_blank">
                             <img className="h-36 md:h-42 lg:h-48 xl:h-56 px-2 p-1" src={card.image2} alt={card.image2Description} />
                          </a>
                          <div className="font-thin pb-4">{card.image2Description}</div>
                        </div>
                        <div className="flex flex-col min-w-42 mx-4 justify-center items-center">
                        <a href={card.image3} target="_blank">
                             <img className="h-36 md:h-42 lg:h-48 xl:h-56 px-2 p-1" src={card.image3} alt={card.image3Description} />
                          </a>
                      ...
                      <p className="font-normal text-start text-balance prose text-slate-400">{card.description}</p>

                    </div>
                    <div className="flex flex-row ml-4 justify-start items-start">

                      <a className="flex flex-row   text-slate-300 pr-2 underline" href={card.linkNetlify}>
                      ...
                      <br></br>
                      <a className="flex flex-row text-slate-300 pr-2 underline" href={card.linkGitHub}>
            ...
            <ul>
              <div className="flex flex-col">
                <div className="flex flex-grow">
                  ...
                  <p className="font-light text-slate-400/75 px-2 text-start leading-tight sm:text-lg md:text-base"></p>

                  <p className="font-light text-slate-400/75 text-start leading-tight sm:text-lg md:text-base">
                    <ul className="px-2">
                      <li>{card.bullet1}</li>
                      <li>{card.bullet2}</li>
                      <li>{card.bullet3}</li>
              ...
              <ul>
                <div className="flex flex-col ">
                  <div className="flex flex-grow">
                      <div className="flex flex-col items-end w-full m-auto justify-end">
                        <div className="p-2">{card.startDate} — {card.endDate}</div> 
                        <img className="p-2 w-36 font-semibold xl:w-42" src={card.logotype} alt={card.altText}></img>
                      </div>
                      </div>
                    ...
                    <p className="px-4 my-2 font-light text-slate-400/75 text-start leading-tight sm:text-lg md:text-base">
                      <ul className="px-2">
                        <li>{card.bullet1}</li>
                        <li>{card.bullet2}</li>
                        <li>{card.bullet3}</li>
              ...
              <div className="flex flex-col justify-center items-center px-4">
                ...
                {/* <div className='px-2'>
                  <a
                    ...
                    aria-label="Impressum — öffnet Impressum-Seite"
                    title="Impressum"
                  >
                    Impressum
                  </a>
                ...
                <div className='font-light text-sm'>©2025 Sebastian Weber</div>
                  ...
                  <div className='px-2'>
                <div className='font-light text-md text-slate-400/75'>Dies ist eine private Portfolio-Website ohne kommerziellen Hintergrund.
Sie dient ausschließlich der Präsentation persönlicher Projekte.</div>
                  </div>
